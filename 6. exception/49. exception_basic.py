...
- 예외처리 키워드는 try와 except를 사용합니다.  (java, JS의 try-catch)
...
# result = n1 / n2
# print(f'{n1} / {n2} = {result}')    # 0으로 나눌 때 ZeroDivisionError




# try - except 예외처리 (ZeroDivisionError 예외처리)
try : 
    n1 = int(input('정수 1 : '))
    n2 = int(input('정수 2 : '))
    ...
    print('0을 입력하지 마세요!')       # 정수 자리에 문자열 입력해도 이렇게 뜸
print('프로그램 정상 종료')



# 예외의 종류가 다양할 때 ex.숫자입력자리에 문자 들어옴
# 다중예외처리 (50. exception_multi.py 에서 계속 . . .)
